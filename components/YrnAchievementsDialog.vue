<i18n lang="yaml">
  ...
  ca:
    ...
    challengesCompleted: "Desafiaments completats"
    activitiesCompleted: "Activitats completades"
    errors: "Errors"
  ...
  de:
    ...
    challengesCompleted: "Abgeschlossene Herausforderungen"
  ...
  eu:
    ...
    challengesCompleted: "Amaitutako erronkak"
    activitiesCompleted: "Amaitutako jarduerak"
    errors: "Akatsak"
  ...
  ja:
    ...
    challengesCompleted: "完了した挑戦"
    activitiesCompleted: "完了したアクティビティ"
    errors: "エラー"
  ...
  ro:
    ...
    challengesCompleted: "Provocări finalizate"
    activitiesCompleted: "Activități finalizate"
    errors: "Erori"
  ...
  ru:
    ...
    challengesCompleted: "Завершенные задания"
    activitiesCompleted: "Завершенные активности"
    errors: "Ошибки"
  ...
  zh:
    ...
    challengesCompleted: "完成的挑战"
    activitiesCompleted: "完成的活动"
    errors: "错误"
    errorsSubtitle: "越少越好！"
...
<template>
  ...
  >
    <template #default>
      <v-card class="yrn-achievements-dialog">
        <v-toolbar
          color="primary"
          dark
        >
        ...
        <v-card-text>
          <v-container>
            <v-row>
              <v-col
                v-if="$store.getters['learningUnit/hasValidIndexPagePassword']"
                cols="12"
              ...
              >
                <yrn-memoji
                  class="mx-auto"
                  :height="100"
                  memoji-name="director-puño"
                />
                <p class="text-h6 text-center mb-0">
                  {{ $t('knowsTheSecretCode') }}
                </p>
                <p class="subtitle-2 text-center font-italic font-weight-thin">
                  {{ $t('knowsTheSecretCodeSubtitle') }}
                </p>
              </v-col>
